...
unsigned char NRF24L01_Write_Buf(unsigned char reg, unsigned char *pBuf, unsigned char chars);//写数据区
unsigned char NRF24L01_Read_Buf(unsigned char reg, unsigned char *pBuf, unsigned char chars);	//读数据区		  
